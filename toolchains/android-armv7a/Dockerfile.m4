...
ENV HOST=arm-linux-androideabi PREFIX=${ANDROID_NDK_HOME}/libs/armv7a-linux-androideabi
...
# armv7a-linux-androideabi16-clang++ is a wrapper script which sets up the Android API version correctly
