...
ENV HOST=aarch64-linux-android PREFIX=${ANDROID_NDK_HOME}/libs/aarch64-linux-android

# We add PATH here for *-config and platform specific binaries
ENV \
	def_binaries(`${HOST}-', `ar, as, c++filt, dwp, ld, nm, objcopy, objdump, ranlib, readelf, strings, strip') \
	CC=aarch64-linux-android21-clang \
# aarch64-linux-android21-clang++ is a wrapper script which sets up the Android API version correctly
